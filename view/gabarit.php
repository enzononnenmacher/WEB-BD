                ...
                <ul class="right chevron">
                    ...
                    <?php if (isset($_SESSION['userEmailAddress'])): ?>
                        ...
                        <?php if (isset($_COOKIE['bookmarks'])): ?>
                            <li><a href="index.php?action=bookmark">Bookmarks</a></li>
                        <?php endif; ?>
        ...
        <div class="line">
            <div class="margin">
                ...
                <div class="s-12 m-12 l-4 margin-m-bottom-2x">
                    ...
                    <p class="text-size-20"><em>"We are routers between people"</em>
                    <p>
                ...
                <section class="padding background-dark">
                    <div class="line">
                        ...
                        <div class="s-12 l-6">
                            <a class="right text-size-12" href="http://www.myresponsee.com"
                               title="Responsee - lightweight responsive framework"><br>Design and coding<br> Cold Zero
                                Team</a>
                        </div>
                    </div>
                </section>
