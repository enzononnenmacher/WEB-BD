    ...
    <main role="main">
        ...
        <article>
            <header class="section background-primary text-center">
                <h1 class="text-white margin-bottom-0 text-size-50 text-thin text-line-height-1">Free Responsive
                    Template</h1>
            </header>
                    ...
                    <div class="margin text-center">
                        <div class="s-12 m-12 l-4 margin-bottom">
                            <div class="padding-2x block-bordered border-radius">
                                ...
                                <p class="margin-bottom-30">Duis autem vel eum iriure dolor in hendrerit in vulputate
